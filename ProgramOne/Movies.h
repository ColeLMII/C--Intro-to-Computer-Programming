...
public:
	...
	Movies* setMovies(int); //mutator
	void destroyMovies(Movies* myMovies); //deconstuctor

	//accessor functions for Movies
	void getMaxMovies(Movies*);
	void getNumMovies(Movies*);
	Movie** getMovies(Movies **);
	void getAMovies(Movies** , int );
